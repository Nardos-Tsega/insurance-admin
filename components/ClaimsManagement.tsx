...
const ClaimsManagement: React.FC = () => {
  ...
  const getStatusIcon = (status: string): React.ReactElement => {
    const icons = {
      ...
      completed: <Shield className="h-3 w-3" />
    };
          ...
          <div key={index} className="bg-white p-4 rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between">
              <div className="flex-1">
                ...
                <p className="text-lg font-semibold text-gray-900 mb-1">{card.value.toLocaleString()}</p>
                <p className="text-xs text-gray-500 flex items-center gap-1">
                  <TrendingUp className="h-3 w-3" />
                  {card.trend}
                </p>
              </div>
              <div className={`w-10 h-10 bg-gradient-to-br ${card.bgColor} rounded-lg flex items-center justify-center`}>
  ...
  const renderErrorBanner = (): React.ReactElement | null => {
    ...
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 mb-4">
      <div className="flex flex-col lg:flex-row gap-3">
        ...
        <div className="flex-1">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-8 pr-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent text-sm"
              value={searchTerm}
        ...
        <div className="flex flex-col sm:flex-row gap-2">
          <select
            className="px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent min-w-[120px] text-sm"
            value={statusFilter}
          ...
          <button className="flex items-center gap-1.5 px-3 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors text-sm">
            <Filter size={14} />
            More Filters
          </button>
        </div>
          ...
          <div className="flex items-center justify-between bg-blue-50 border border-blue-200 rounded-lg p-3">
            <div className="flex items-center gap-2">
              <div className="w-6 h-6 bg-blue-100 rounded-full flex items-center justify-center">
                <span className="text-blue-700 font-medium text-xs">{selectedClaims.length}</span>
              </div>
      ...
      <div className="px-4 py-3 border-b border-gray-200 bg-gray-50">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 text-xs text-gray-600">
            <span>Show</span>
            <select 
              className="border border-gray-300 rounded px-2 py-1 focus:outline-none focus:ring-2 focus:ring-emerald-500 text-xs"
              value={itemsPerPage}
              onChange={(e) => {
        ...
        <table className="w-full">
          <thead className="bg-gray-50 border-b border-gray-200">
            <tr>
              ...
              <th className="text-left px-3 py-2 text-xs font-medium text-gray-600">Claim Details</th>
              <th className="text-left px-3 py-2 text-xs font-medium text-gray-600">Vehicle</th>
              <th className="text-left px-3 py-2 text-xs font-medium text-gray-600">Status</th>
              <th className="text-left px-3 py-2 text-xs font-medium text-gray-600">Images</th>
              <th className="text-left px-3 py-2 text-xs font-medium text-gray-600">Created</th>
              ...
              <tr key={claim.id} className="hover:bg-gray-50 transition-colors">
                ...
                <td className="px-3 py-2">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-gray-500">User ID: {claim.user_id}</div>
                      {claim.description && (
                ...
                <td className="px-3 py-2">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <div className="font-medium text-gray-900 capitalize text-sm">{claim.car_brand}</div>
                      <div className="text-xs text-gray-500 capitalize">{claim.car_type}</div>
                    </div>
                  </div>
                </td>
                  ...
                  <div className="flex items-center gap-2">
                    <div className="flex -space-x-1">
                      {(claim.images || []).slice(0, 3).map((image, imageIndex) => (
                        <div
                          key={image.id}
                          className="w-6 h-6 rounded-lg border-2 border-white bg-gray-100 overflow-hidden cursor-pointer hover:scale-110 transition-transform"
                      ...
                      {(claim.images || []).length > 3 && (
                        <div className="w-6 h-6 rounded-lg border-2 border-white bg-gray-200 flex items-center justify-center">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="px-2 py-1 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed text-xs"
              >
                <ChevronLeft className="h-3 w-3" />
              </button>
              
              <span className="px-3 py-1 text-xs font-medium text-gray-900">
  ...
  const renderEmptyState = (): React.ReactElement => (
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
      <div className="text-center">
        ...
        <h3 className="text-base font-semibold text-gray-900 mb-2">No claims found</h3>
